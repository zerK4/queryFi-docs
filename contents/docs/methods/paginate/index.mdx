...
This documentation covers both the `paginate` and `page` methods, with examples of how to use them in TypeScript, how the generated query parameters will look, and how to build the corresponding query strings for pagination. Let me know if you need further adjustments!