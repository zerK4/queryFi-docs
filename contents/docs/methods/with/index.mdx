...
- Use **single string values** for loading one relation.  
- Use **arrays of strings** for multiple relations.  
- Use **type-safe arrays** when defining relations dynamically.  

This ensures concise, clear, and scalable queries for models and related data. 🚀